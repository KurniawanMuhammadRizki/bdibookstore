      ...
      <div class="content">
                    ...
                    <div id="id01" class="modal">
                      <form class="modal-content animate" action="prosesTambahBuku.php" method="post">
                        <div class="container">
                          ...
                          <input class="form-control mt-1" type="text" placeholder="Maasukkan ID Buku" name="id_buku" required>
                          ...
                          <input class="form-control mt-1" type="text" placeholder="Maasukkan Nama Buku" name="nama_buku" required>
        ...
        $query = mysqli_query($koneksi, "SELECT * FROM buku ORDER BY nama_buku asc") or die(mysqli_error($koneksi)); if (mysqli_num_rows($query) == 0) {echo '<tr><td colspan="6">Tidak ada data!</td></tr>';} 
          ...
          while ($data = mysqli_fetch_assoc($query)) {
            ...
            <td>
              <button class="btn btn-primary" <?php $ubah = $data['id_buku'];?> onclick="document.getElementById('id05').style.display='block'" style="width:auto;">Tambah Data <?php echo $ubah ?></button>
              <a class="btn btn-warning btn-xs" href="../admin/editDiklat.php?id=' .  $data['id'] . '"><i class="mr-1 fa fa-edit"></i>Edit</a> / 
            ...
            $no++;
                  ...
                  <div id="id05" class="modal">
                      ...
                      <form class="modal-content animate" action="prosesTambahBuku.php" method="post">
                        <div class="container">
                          <label for="id_buku"><b>ID Buku</b></label>
                          <input class="form-control mt-1" type="text" placeholder="Maasukkan ID Buku" name="id_buku" value=" <?php echo $ubah ?>" required>
                          <label for="kategori"><b>Kategori</b></label>
                          <input class="form-control mt-1" type="text" placeholder="Maasukkan Kategori" name="kategori" required>
                          <label for="nama_buku"><b>Nama Buku</b></label>
                          <input class="form-control mt-1" type="text" placeholder="Maasukkan Nama Buku" name="nama_buku" required>
                          ...
                          <input class="form-control mt-1" type="text" placeholder="Maasukkan Penerbit Buku" name="penerbit" required>
                          <button type="submit" name="kirim" value="kirim">Tambah</button>
                          <button type="button" onclick="document.getElementById('id05').style.display='none'" >Batalkan</button>
                        </div>
                      </form>
                    </div>
